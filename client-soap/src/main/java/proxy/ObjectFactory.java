...
public class ObjectFactory {
    ...
    private final static QName _JAXBException_QNAME = new QName("http://ws/", "JAXBException");
    private final static QName _GetReleve_QNAME = new QName("http://ws/", "getReleve");
    private final static QName _GetReleveResponse_QNAME = new QName("http://ws/", "getReleveResponse");
    private final static QName _Operation_QNAME = new QName("http://ws/", "operation");
    private final static QName _Operations_QNAME = new QName("http://ws/", "operations");
     ...
     */
    @XmlElementDecl(namespace = "http://ws/", name = "JAXBException")
     ...
     */
    @XmlElementDecl(namespace = "http://ws/", name = "getReleve")
     ...
     */
    @XmlElementDecl(namespace = "http://ws/", name = "getReleveResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://ws/", name = "operations")
